...
const dummyMeals = [
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://www.allrecipes.com/thmb/8QzNWDvGhdry6V1jnyJWIhKA_nk=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/20144-banana-banana-bread-mfs-57-0bb49d050a6941c4b3715e57b8e6badd.jpg',
    duration: 20,
    ingredients: [
      'Flour',
      '1 Tablespoon of Olive Oil',
    ...
    steps: [
      ...
      'mashed bananas have plenty of moisture on their own. Make sure you store the banana bread properly to keep it moist for several days.',
